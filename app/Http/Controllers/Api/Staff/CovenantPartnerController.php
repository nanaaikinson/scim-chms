...
class CovenantPartnerController extends Controller
{
  use ResponseTrait;
  ...
  {
    try {
      $contribution = Contribution::where("type", ContributionTypeEnum::CovenantPartner)->get();
  ...
  public function store(StoreContributionRequest $request)
  {
    try {
      ...
      foreach ($validated->contributions as $item) {
        ...
        $contribution->type = ContributionTypeEnum::CovenantPartner;
      ...
      return $this->successResponse("Covenant partner contribution(s) saved successfully");
    } catch (Exception $e) {
      return $this->errorResponse($e->getMessage());
    }
  }
  ...
  public function show(int $mask)
  {
    try {
      $contribution = Contribution::with("person")->where("mask", $mask)
        ->where("type", ContributionTypeEnum::CovenantPartner)
        ->firstOrFail();
  ...
  public function update(UpdateContributionRequest $request, int $mask)
  {
    try {
      $validated = (object)$request->validationData();
      $contribution = Contribution::where("mask", $mask)->where("type", ContributionTypeEnum::CovenantPartner)->firstOrFail();
      ...
      if ($contribution->save()) {
        return $this->successResponse("Covenant partner contribution updated successfully");
      }
  ...
  {
    try {
      $tithe = Contribution::where("mask", $mask)->where("type", ContributionTypeEnum::CovenantPartner)->firstOrFail();
      if ($tithe->delete()) {
        return $this->successResponse("Covenant partner contribution deleted successfully");
      }
